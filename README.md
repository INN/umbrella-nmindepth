...
3. Copy the contents of the new directory `umbrella-nmindepth/` into `htdocs/`, including all hidden files whose names start with `.` periods.
...
9. Search and replace 'nmindepth.wpengine.com' --> 'nmindepth.dev' in the db (options for doing this are covered in the [largo umbrella setup instructions](https://github.com/INN/docs/blob/master/projects/largo/umbrella-setup.md)
10. Optionally, you may want to pull down recent uploads so you have images, etc. to work with locally.
11. Visit nmindepth.dev in your browser and you should see the site!
